classdef mlepAwsProcess < handle
    ...
    methods
        ...
        %%==============================================================
        function [status, msg, EC2_info] = initAwsInstance(obj, numInst, instType)
            EC2_info = mlepInitAwsInstance(obj.ec2Client, numInst, obj.keyPath, obj.secGroup, instType);
        ...
        function [status, msg, EC2_info] = getAwsInstanceInfo(obj)
            EC2_info = mlepGetAwsInstanceInfo(obj.ec2Client);
        ...
        %%==============================================================
        function status = runSimulationOnAWSmlep(obj, lFolder, rFolder, feed)
            mlepRunSimulation2(obj.ec2Info, obj.keyPath, lFolder, rFolder, feed);
            status = 0;
        end
        %%==============================================================
